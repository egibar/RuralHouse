...
public class Offer implements Serializable {
	...
	private Booking booking; // That is: java.sql.Date is a subclass (or
								// extends) java.util.Date
	private RuralHouse ruralHouse;

	public Offer(int offerNumber, RuralHouse ruralHouse, Date firstDay,
	...
	public Booking createBooking(int numBooking, String bookTelephoneNumber,
			User u) {
		return booking = new Booking(numBooking, bookTelephoneNumber, this, u);

	}

	public String toString() {
		return offerNumber + ";" + firstDay.toString() + ";"
				+ lastDay.toString() + ";" + price + ";" + ruralHouse;
	}
}